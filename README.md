...
- **[ITCH 5.0 Parser](https://github.com/ShubhamSarvankar/itch-parser):** From-scratch C++20 limit order book reconstruction for NASDAQ TotalView-ITCH 5.0. Replays a real 263M-message, 7.7 GB production capture end-to-end at 1.16M msg/s (231ns median apply latency). Fixed-point price arithmetic throughout; 105 tests covering feed-gap corruption, crossed books, and shutdown races.
